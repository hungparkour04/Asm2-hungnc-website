document.getElementById('loginForm').addEventListener('submit', function (event) {
    ...
    if (username.trim() === '' || password.trim() === '') {
        ...
        if (username === 'hungnc_04' && password === 'P@s12345') 
        {
...
1
    ...
    if (username.trim() === '' || password.trim() === '') {
        ...
        // Dummy authentication check
        if (username === 'conghung_2' && password === 'P@s12345') 
        {
            // Display a success message for successful login
            document.getElementById('loginMessage').innerHTML = '<p style="color: green;">Login successful!</p>';
    ...
    if (username.trim() === '' || password.trim() === '') {
        ...
        // Dummy authentication check
        if (username === 'hunghapy_1' && password === 'P@s12345') 
        {
            // Display a success message for successful login
            document.getElementById('loginMessage').innerHTML = '<p style="color: green;">Login successful!</p>';
    ...
    if (username.trim() === '' || password.trim() === '') {
        ...
        // Dummy authentication check
        if (username === 'hungcong_1' && password === 'P@s12345') 
        {
            // Display a success message for successful login
            document.getElementById('loginMessage').innerHTML = '<p style="color: green;">Login successful!</p>';
